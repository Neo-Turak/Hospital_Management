...
If (Label4.Caption = "内科" Or Label4.Caption = "外科") And (Label1.Caption = "医生" Or Label1.Caption = "组长") Then
...
If Trim(Label2.Caption) = Trim(TxtPassword.Text) Then
    '检查正确的密码
        ...
        Me.Hide
          医生工作站MDI.Show
       医生工作站MDI.StatusBar1.Panels(3) = Label3.Caption
        医生工作站MDI.StatusBar1.Panels(4) = Label4.Caption
       医生工作站MDI.StatusBar1.Panels(5) = Label1.Caption
    Else
...
ConnectString = "Provider=SQLOLEDB.1;Persist Security Info=true;User ID=sa;password=sa;Initial Catalog=ghgl;Data Source=TOP-PC"
